...
#define NT35510_PWM_PERIOD_NSEC	(NSEC_PER_SEC / NT35510_PWM_FREQ_HZ)
#define NT35510_PWM_DUTY_LEVEL	(NT35510_PWM_PERIOD_NSEC / NT35510_PWM_LEVEL)

static struct mddi_panel_platform_data *pdata;
static struct pwm_device *bl_pwm;

static int mddi_nt35510_panel_on(struct platform_device *pdev)
{
...
static void mddi_nt35510_panel_set_backlight(struct msm_fb_data_type *mfd)
{
	...
	pwm_config(bl_pwm,
		(NT35510_PWM_DUTY_LEVEL * mfd->bl_level) / NSEC_PER_USEC,
		NT35510_PWM_PERIOD_NSEC / NSEC_PER_USEC);
...
static struct msm_fb_panel_data nt35510_panel_data = {
	.on = mddi_nt35510_panel_on,
	.off = mddi_nt35510_panel_off,
	.set_backlight = mddi_nt35510_panel_set_backlight,
};
...
static int __init mddi_nt35510_wvga_init(void)
{
	int ret;
	struct msm_panel_info *pinfo;

#ifdef CONFIG_FB_MSM_MDDI_AUTO_DETECT
	if (msm_fb_detect_client("mddi_nt35510_wvga"))
		return -ENODEV;

	if ((0xb9f6 << 16 | 0x5510) != mddi_get_client_id())
		return -ENODEV;
#endif
...
module_init(mddi_nt35510_wvga_init);
